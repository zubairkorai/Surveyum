  ...
  return (
    <div className="flex-1 flex flex-col w-full px-8 sm:max-w-md justify-center gap-6">
      ...
      <div className="bg-white border rounded-3xl p-8 shadow-xl shadow-blue-100/50">
        ...
        >
          <div className="mb-4">
            <h1 className="text-3xl font-extrabold text-gray-900 tracking-tight">Login to Surveyum</h1>
            <p className="text-gray-500 text-sm mt-2 font-medium">Enter your credentials to access your dashboard.</p>
          </div>
