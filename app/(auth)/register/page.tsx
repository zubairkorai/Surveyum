    ...
    <div className="flex-1 flex flex-col w-full px-6 sm:max-w-md justify-center bg-white dark:bg-[#111827] min-h-screen pt-20 pb-12 transition-colors duration-300">
      ...
      <div className="w-full">
        <div className="flex flex-col mb-8 items-center">
          ...
          <h1 className="text-2xl font-semibold text-gray-900 dark:text-white tracking-tight text-center">Create your account</h1>
          <p className="text-gray-500 dark:text-gray-400 text-sm mt-1.5 text-center">Join thousands of researchers building better surveys.</p>
        </div>
        ...
        <form className="flex flex-col w-full gap-5" action={signup}>
          ...
          <div className="text-sm text-center mt-6 pt-6 border-t border-gray-100 dark:border-gray-800 text-gray-500 dark:text-gray-400">
            ...
            <Link href="/login" className="font-semibold text-blue-600 dark:text-blue-400 hover:text-blue-700 dark:hover:text-blue-300 transition-colors text-sm">
              Sign in instead
            </Link>
          </div>
        </form>
